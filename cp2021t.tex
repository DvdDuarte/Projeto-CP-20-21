...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outExpAr}\mathbin{::}\Conid{ExpAr}\;\Varid{a}{}\<[22]%
\>[22]{}\to ()+(\Varid{a}+((\Conid{BinOp},(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}))+(\Conid{UnOp},\Conid{ExpAr}\;\Varid{a}))){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;\Conid{X}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{N}\;\Varid{n})\mathrel{=}{}\<[19]%
\>[19]{}i_2\;(i_1\;\Varid{n}){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{x}\;\Varid{y}\;\Varid{z})\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{x},(\Varid{y},\Varid{z})))){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{a})\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{op},\Varid{a}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseExpAr'}\;\Varid{g}\;\Varid{f}\mathrel{=}\Varid{baseExpAr}\;\Varid{id}\;\Varid{g}\;\Varid{id}\;{}\<[37]%
\>[37]{}\Varid{f}\;\Varid{f}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}}
           \ar[d]_-{\ensuremath{\cata{\Varid{g}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}(\Conid{BinUp}\times(\Conid{ExpAr}\;\Conid{A}\times\Conid{ExpAr}\;\Conid{A}))\mathbin{+}(\Conid{UnOp}\times\Conid{ExpAr}\;\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\mathbin{+}(\Varid{id}\times(\cata{\Varid{g}}\times\cata{\Varid{g}}))\mathbin{+}(\Varid{id}\times\cata{\Varid{g}})}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{\Conid{A}}
&
...
\column{19}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{escalar}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{g1}\mathrel{=}\underline{\Varid{escalar}}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g2}\mathrel{=}\alt{\Varid{id}}{\Varid{g3}}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g3}\mathrel{=}\alt{\Varid{g4}}{\Varid{g5}}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g4}\;(\Varid{operacao},(\Varid{d1},\Varid{d2})){}\<[E]%
\\
\>[12]{}\hsindent{1}{}\<[13]%
\>[13]{}\mid (\Varid{operacao}\equiv \Conid{Product})\mathrel{=}\Varid{d1}\mathbin{*}\Varid{d2}{}\<[E]%
\\
\>[12]{}\hsindent{1}{}\<[13]%
\>[13]{}\mid (\Varid{operacao}\equiv \Conid{Sum})\mathrel{=}\Varid{d1}\mathbin{+}\Varid{d2}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g5}\;(\Varid{operacao},\Varid{d1}){}\<[E]%
\\
\>[12]{}\hsindent{1}{}\<[13]%
\>[13]{}\mid (\Varid{operacao}\equiv \Conid{Negate})\mathrel{=}\mathbin{-}\Varid{d1}{}\<[E]%
\\
\>[12]{}\hsindent{1}{}\<[13]%
\>[13]{}\mid (\Varid{operacao}\equiv \Conid{E})\mathrel{=}\Varid{expd}\;\Varid{d1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{clean}\mathbin{::}\Conid{ExpAr}\;\Varid{a}{}\<[19]%
\>[19]{}\to ()+(\Varid{a}+((\Conid{BinOp},(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}))+(\Conid{UnOp},\Conid{ExpAr}\;\Varid{a}))){}\<[E]%
\\
\>[B]{}\Varid{clean}\;\Conid{X}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{N}\;\Varid{n})\mathrel{=}{}\<[16]%
\>[16]{}i_2\;(i_1\;\Varid{n}){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Varid{x}\;\Varid{y}\;\Varid{z})\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{x},(\Varid{y},\Varid{z})))){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Varid{op}\;\Varid{a})\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{op},\Varid{a}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gopt}\;\Varid{e}\mathrel{=}\alt{\Varid{c}}{\alt{\Varid{n}}{\alt{\Varid{bop}}{\Varid{uop}}}}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{where}\;\Varid{c}\mathrel{=}\underline{\Varid{e}}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{n}\;\Varid{x}\mathrel{=}\Varid{x}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{bop}\;(\Conid{Sum},(\mathrm{0},\Varid{d2}))\mathrel{=}\Varid{d2}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{bop}\;(\Conid{Sum},(\Varid{d1},\mathrm{0}))\mathrel{=}\Varid{d1}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{bop}\;(\Conid{Sum},(\Varid{d1},\Varid{d2}))\mathrel{=}\Varid{d1}\mathbin{+}\Varid{d2}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{bop}\;(\Conid{Product},(\mathrm{1},\Varid{d2}))\mathrel{=}\Varid{d2}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{bop}\;(\Conid{Product},(\Varid{d1},\mathrm{1}))\mathrel{=}\Varid{d1}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{bop}\;(\Conid{Product},(\Varid{d1},\Varid{d2}))\mathrel{=}\Varid{d1}\mathbin{*}\Varid{d2}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{uop}\;(\Conid{Negate},\Varid{d1})\mathrel{=}\mathbin{-}\Varid{d1}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{uop}\;(\Conid{E},\Varid{d1})\mathrel{=}\Varid{expd}\;\Varid{d1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{sd\char95 gen}\;(i_2\;(i_1\;\Varid{k}))\mathrel{=}(\Conid{N}\;\Varid{k},\Conid{N}\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\;(i_2\;(i_2\;(i_1\;(\Conid{Sum},((\Varid{d1},\Varid{d2}),(\Varid{d3},\Varid{d4}))))))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{d1}\;\Varid{d3},\Conid{Bin}\;\Conid{Sum}\;\Varid{d2}\;\Varid{d4}){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\;(i_2\;(i_2\;(i_1\;(\Conid{Product},((\Varid{d1},\Varid{d2}),(\Varid{d3},\Varid{d4}))))))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{d1}\;\Varid{d3},(\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{d1}\;\Varid{d4})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{d2}\;\Varid{d3}))){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\;(i_2\;(i_2\;(i_2\;(\Conid{Negate},(\Varid{d1},\Varid{d2})))))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{d1},\Conid{Un}\;\Conid{Negate}\;\Varid{d2}){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\;(i_2\;(i_2\;(i_2\;(\Conid{E},(\Varid{d1},\Varid{d2})))))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{d1},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{d1})\;\Varid{d2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\mathbin{::}\Conid{Floating}\;\Varid{a}\Rightarrow \Varid{a}\to ()+(\Varid{a}+((\Conid{BinOp},((\Conid{ExpAr}\;\Varid{a},\Varid{a}),(\Conid{ExpAr}\;\Varid{a},\Varid{a})))+(\Conid{UnOp},(\Conid{ExpAr}\;\Varid{a},\Varid{a}))))\to (\Conid{ExpAr}\;\Varid{a},\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\anonymous \;(i_1\;())\mathrel{=}(\Conid{X},\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\anonymous \;(i_2\;(i_1\;\Varid{k}))\mathrel{=}(\Conid{N}\;\Varid{k},\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\anonymous \;(i_2\;(i_2\;(i_1\;(\Conid{Sum},((\Varid{d1},\Varid{d2}),(\Varid{d3},\Varid{d4}))))))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{d1}\;\Varid{d3},\Varid{d2}\mathbin{+}\Varid{d4}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{x}\;(i_2\;(i_2\;(i_1\;(\Conid{Product},((\Varid{d1},\Varid{d2}),(\Varid{d3},\Varid{d4})))))){}\<[65]%
\>[65]{}\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{d1}\;\Varid{d3},\Varid{d4}\mathbin{*}\Varid{eval\char95 exp}\;\Varid{x}\;\Varid{d1}{}\<[107]%
\>[107]{}\mathbin{+}\Varid{d2}\mathbin{*}\Varid{eval\char95 exp}\;\Varid{x}\;\Varid{d3}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\anonymous \;(i_2\;(i_2\;(i_2\;(\Conid{Negate},(\Varid{d1},\Varid{d2})))))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{d1},\Varid{negate}\;\Varid{d2}){}\<[E]%
\\
\>[B]{}\Varid{ad\char95 gen}\;\Varid{x}\;(i_2\;(i_2\;(i_2\;(\Conid{E},(\Varid{d1},\Varid{d2})))))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{d1},(\Varid{expd}\;(\Varid{eval\char95 exp}\;\Varid{x}\;\Varid{d1}))\mathbin{*}\Varid{d2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Seja $cat\ = c\ n$ a função pretendida. Podemos ver que \ensuremath{\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}} e, tal como visto em cima, $\ensuremath{\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \frac{2(2n+1)}{n+2} * \ensuremath{\Varid{c}\;\Varid{n}} = \frac {4n +2}{n+2} * \ensuremath{\Varid{c}\;\Varid{n}}$. Se definirmos $\ensuremath{\Varid{a}\;\Varid{n}} = 4n + 2$ e $\ensuremath{\Varid{b}\;\Varid{n}} = n + 2$ temos:

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{a}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{a}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{4}\mathbin{+}\Varid{a}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{b}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{b}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{b}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{c}\mathbin{::}\Conid{Integer}\to \Conid{Integer}{}\<[E]%
\\
\>[B]{}\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{a}\;\Varid{n})\mathbin{*}\Varid{c}\;\Varid{n}\div \Varid{b}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{a}\mathbin{::}\Conid{Integer}\to \Conid{Integer}{}\<[E]%
\\
\>[B]{}\Varid{a}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{a}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{4}\mathbin{+}\Varid{a}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{b}\mathbin{::}\Conid{Integer}\to \Conid{Integer}{}\<[E]%
\\
\>[B]{}\Varid{b}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{b}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{b}\;\Varid{n}{}\<[E]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{loop}\;(\Varid{c},\Varid{a},\Varid{b})\mathrel{=}(\Varid{a}\mathbin{*}\Varid{c}\div \Varid{b},\mathrm{4}\mathbin{+}\Varid{a},\mathrm{1}\mathbin{+}\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{2}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{prj}\;(\Varid{c},\Varid{a},\Varid{b})\mathrel{=}\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{h}\mathrel{=}\alt{\underline{\underline{\Varid{nil}}}}{\Varid{x}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{x}\mathbin{::}(\Q ,\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint})\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{x}\;(\Varid{d},\Varid{f})\;\Varid{l}\mathrel{=}\mathbf{case}\;\Varid{l}\;\mathbf{of}{}\<[E]%
\\
\>[4]{}\hsindent{4}{}\<[8]%
\>[8]{}[\mskip1.5mu \mskip1.5mu]{}\<[15]%
\>[15]{}\to \Varid{nil}{}\<[E]%
